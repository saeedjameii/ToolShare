    ...
    <main class="page-area">
        <div class="main-content">
            <section class="intro">
                ...
                <p class="intro-copy">Tell your neighbours about the useful tools ready for their next project. You can
                    review every detail before publishing.</p>
            </section>

            <div class="workspace">
                <form action="{{ route('create.post') }}" method="POST" enctype="multipart/form-data" id="listing-form">
                    @csrf
                    @if ($errors->any())
                    ...
                    <section class="form-section">
                        <div class="section-heading"><span class="step-number">01</span>
                            <div>
                                <h2>Tool details</h2>
                                <p class="section-description">Help renters quickly understand what they are borrowing.</p>
                            </div>
                        </div>
                    ...
                    <section class="form-section">
                        <div class="section-heading"><span class="step-number">02</span>
                            <div>
                                ...
                                <p class="section-description">Set a simple daily price and choose when your tool can be
                                    picked up.</p>
                            </div>
                        </div>
                        <div class="field-grid">
                    ...
                    <section class="form-section">
                        <div class="section-heading"><span class="step-number">03</span>
                            <div>
                                <h2>Photos</h2>
                                <p class="section-description">Bright, clear photos help your listing stand out.</p>
                            </div>
                        </div>
                        <label class="upload-zone" for="tool-photos">
                            <input id="tool-photos" name="images[]" type="file" accept="image/*" multiple>
                            <span><span class="upload-icon">＋</span><span class="upload-title">Drop photos here or choose
                                    files</span><span class="upload-copy">Choose up to 5 images. They are shown only in
                                    this preview and are not uploaded.</span></span>
                        </label>
                    ...
                    <section class="form-section">
                        <div class="section-heading"><span class="step-number">04</span>
                            <div>
                                <h2>Rental notes</h2>
                                <p class="section-description">Optional details for a smoother handover.</p>
                            </div>
                        </div>
                        <div class="field"><label for="rental-notes">Notes for renters (optional)</label>
                            <textarea class="form-control" id="rental-notes" name="rental-notes" maxlength="400"
                                placeholder="e.g. Please return the tool clean and fully charged."></textarea>
                        </div>
                    </section>
                ...
                <aside class="preview-wrap">
                    <section class="preview-card">
                        <div class="preview-heading">
                            <h2>Listing preview</h2><span class="preview-badge">Preview</span>
                        </div>
                        ...
                        <div class="preview-body">
                            ...
                            <div class="preview-price-box">
                                <p class="preview-price-label">Rental price</p>
                                <p id="preview-price" class="preview-price">$0 first day · $0 extra day</p>
                            </div>
                        </div>
                    </section>
                    <p class="review-note"><span>✓</span><span>Your listing can be reviewed before it is published.</span>
                    </p>
                </aside>
            </div>
        </div>
